...
Inspecting panel (a), we visualisation the precision of our CTmin estimate for *Catorhintha schaffneri*, whereby precision is measured as the width of a 95% confidence interval. For example, in the context of CTLs, a CI width of 1 indicates that practitioners can be 95% confident that their CTL estimate is within 1‹C of the true CTmin value. The smaller the CI width, the greater the precision of the CTL estimate.  
